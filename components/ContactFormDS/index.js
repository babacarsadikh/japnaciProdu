...
class ContactFormDS extends Component {
    state = {
        nomComplet: '',
        email: '',
        telephone: '',
    ...
    submitHandler = async (e) => {
        ...
        if (!hasErrors) {
            ...
            try {
                ...
                toast.success(`Merci ${nomComplet} pour votre don de sang, l'équipe de Japanaci vous contactera 👍🏽`, {
